...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Привет. Я бот психолога Евы Кулик, выбери из меню, что тебя интересует", reply_markup=markup)
...
async def reply(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text in ["Индивидуальная сессия", "Семейная терапия", "Стратегическая сессия"]:
        ...
        about = (
            "👩🏻‍💼 Я психолог, ведущий частную практику в Москве и онлайн по всему миру.\n\n"
            "Самопознание открывает человеку мир, в котором находится важный источник вдохновения жить и воплощать себя в реальности. Это большая лаборатория души, где познавая и смешивая ингредиенты своей внутренней реальности вы познаете и творите себя, self-made. Вы - главный продукт своей жизни. И важно чтобы вы были им довольны. Какой вы человек и каким хотите себя сделать.\n\n"
            "При этом решая задачи о том, как хорошо жить во внешней материальной реальности, как сбалансировать все сферы жизни, куда двигаться дальше и как во всем преуспевать.\n\n"
            "Как согласовать внутреннее и внешнее, ничего важного не утратив, созидая это все в красивый жизненный путь.\n\n"
            "<b>Образование:</b>\n"
            ...
            "• Проф переподготовка на специальность \"организационный психолог\", \"психологическое бизнес-консультирование\" — диплом 2025г\n"
            "• И др обучения в сфере психологии в различных подходах.\n\n"
            "С 2007 года веду частную практику психолога-консультанта."
        )
